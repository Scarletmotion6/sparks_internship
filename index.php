...
<body>
    ...
    <div class="card text mb-3" id="imagecard">
        <div class="card-body">
            <h2 class="card-title">About Sparksbank</h2>
            <h4 class="card-text">A safe,secure and efficient platform. Avoiding delay in the process, save your money with ease.</h4>
        </div>
    </div>
    ...
    <article>
        ...
        <div class="card" style="width: 18rem;" id="dashcard">
            ...
            <div class="card-body">
                ...
                <p class="card-text">View overall details of the existing customers.</p>
        ...
        <div class="card" style="width: 18rem;" id="transfercard">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Select and Transfer your money safely</p>
